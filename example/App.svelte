<script>
  ...
  /** Playwright e2e: Bob needs dialable multiaddrs; peer-id-only is unreliable across isolated contexts. */
  $effect(() => {
...
<div
  style="margin: 0; padding: 0; height: 100vh; background: #0f1117; color: #d4d4d8; font-family: 'JetBrains Mono', 'Fira Code', monospace; display: flex; flex-direction: column;"
>
  <!-- Header -->
  <div
